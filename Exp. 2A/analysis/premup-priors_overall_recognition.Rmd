...
data <- subset(x = temp,
               select = c("participant", "session", "id_acc", "OvsN", "rec_response"))
```
...
# Find outliers
poor_performers <- SDT_out$participant[SDT_out$corr_hit < .23]
...
# Find outliers
poor_performers <- SDT_out$participant[SDT_out$corr_hit < .27]
